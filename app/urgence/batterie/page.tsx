...
export default function UrgenceBatterie() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-xl">
              ...
              <p className="mt-6 text-lg text-gray-600 hidden md:block">
                Batterie à plat ? Notre équipe intervient rapidement chez vous, sur votre lieu de travail ou sur la route, partout à St-Étienne et ses alentours. Recharge, remplacement, diagnostic - nous avons la solution.
              </p>
              
              {/* Mobile paragraph */}
              <p className="mt-4 text-base text-gray-600 md:hidden">
                Batterie à plat ? Intervention rapide à St-Étienne et alentours. Recharge ou remplacement sur place.
              </p>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-400">
                Arrivée en moins de 30 minutes sur St-Étienne et ses environs.
              </p>
            </div>
            <div className="text-center p-6">
              <div className="w-16 h-16 rounded-full bg-yellow-500/20 flex items-center justify-center mx-auto mb-4">
